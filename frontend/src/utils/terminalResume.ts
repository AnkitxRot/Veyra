// M86 — resume a detached sandbox PTY after a same-tab remount (reload or
 ...
 *  presents the previous user's terminalId (they would only `ended`, but the
 *  first-open UX would be wrong). */
